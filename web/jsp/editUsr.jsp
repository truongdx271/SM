        ...
        <div class="page-container">
            <div class="left-content">
                <div class="mother-grid-inner">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<s:url action="index"></s:url>">Trang chủ</a> <i class="fa fa-angle-right"></i><a href="<s:url action="userListPaging"></s:url>">Người dùng</a> <i class="fa fa-angle-right"></i>Sửa</li>
                        </ol>
                        ...
                        <s:form method="post" theme="simple" action="editUsrPr" cssClass="form-horizontal" enctype="multipart/form-data">
                            <%--<s:token/>--%>
                            <div class="form-group">
                                <label class="col-sm-2 control-label hor-form">Id</label>
                                <div class="col-sm-8">
                                    <s:textfield name="id" cssClass="form-control"  readonly="true"></s:textfield>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                    <s:select list="role" cssClass="form-control1" name="listName" listKey="key" listValue="value" value="usr.role" ></s:select>
                                    </div>
                                </div>    
